...
def histories(ts, branches, func, mhmin, **kwargs):
    storage = {}
...
if __name__ == '__main__':
    ...
    save_histories_most_massive_halos(basepath, a_target, mhmin=mhmin, agecut=agecut)